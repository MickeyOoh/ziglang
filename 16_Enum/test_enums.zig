...
test "enum ordinal value" {
    ...
    print("@intFromEnum(Value.zero):{}\n", .{@intFromEnum(Value.zero)});
    print("@intFromEnum(Value.one):{}\n", .{@intFromEnum(Value.one)});
    print("@intFromEnum(Value.two):{}\n", .{@intFromEnum(Value.two)});
}
...
test "set enum ordinal value" {
    ...
    print("@intFromEnum(Value2.hundred):{}\n", .{@intFromEnum(Value2.hundred)});
    print("@intFromEnum(Value2.thousand):{}\n", .{@intFromEnum(Value2.thousand)});
    print("@intFromEnum(Value2.million):{}\n", .{@intFromEnum(Value2.million)});
}
